...
@WebServlet("/IU_Show_Employees_Super")
public class IU_Show_Employees_Super extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<center><caption>Employees List</caption></center>\n"
                    ...
                    + "      <th scope=\"col\" href=\"\" >Edit Info</th>\n"//EDITAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAR
                    + "    </tr>\n"
                    + "  </thead>\n"
                    + "  <tbody>");
            for (Informacion_del_Empleado e : list) {
                out.print("<tr><td>" + e.getId() + "</td><td>" + e.getName() + "</td><td><a href='IU_UPDATE_BRACKET?ID_E=" + e.getId() + "'>edit</a></td></tr></tbody>");
            }
            out.print("</table>");

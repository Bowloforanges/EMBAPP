...
@WebServlet("/IU_Score_Employees")
public class IU_Score_Employees extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<center><caption>Employees List</caption></center>\n"
                    ...
                    + "      <th scope=\"col\" href=\"\" >Score</th>\n"
                    + "    </tr>\n"
                    + "  </thead>\n"
                    + "  <tbody>");
            for (Informacion_del_Empleado e : list) {
                out.print("<tr><td>" + e.getId() + "</td><td>" + e.getName() + "</td><td><a href='IU_UPDATE_SCORE?ID_E=" + e.getId() + "'>Edit</a></td></tr></tbody>");
            }
            out.print("</table>");

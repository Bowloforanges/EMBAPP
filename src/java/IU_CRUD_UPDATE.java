...
public class IU_CRUD_UPDATE extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<form action=\"CTL_CRUD_UPDATE\" method=\"get\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type=\"hidden\" id=\"fname\" name=\"ID_E\" value='" + e.getId() + "' placeholder=\"Employee's ID\">\n"
                + "            </div>\n"
                + "        </div>\n"
                + "        <div class=\"row\">\n"
                + "            <div class=\"col-25\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type=\"text\" id=\"lname\" name=\"Apellido\" value='" + e.getLast_Name()+ "' placeholder=\"Employee's Last Name\">\n"
                + "            </div>\n"
                + "        </div>\n"
                + "        <div class=\"row\">\n"
                + "            <div class=\"col-25\">\n"

...
public class IU_CRUD_UPDATE extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<form action=\"CTL_CRUD_UPDATE\" method=\"get\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type=\"hidden\" id=\"fname\" name=\"ID_E\" value='" + e.getId() + "' placeholder=\"Employee's ID\" required maxlength=\"6\" type=\"number\">\n"
                + "            </div>\n"
                + "        </div>\n"
                + "        <div class=\"row\">\n"
                + "            <div class=\"col-25\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type=\"text\" id=\"lname\" name=\"Nombre\" value='" + e.getName() + "' placeholder=\"Employee's Name\" required maxlength=\"45\" >\n"
                + "            </div>\n"
                + "        </div>\n"
                + "        <div class=\"row\">\n"
                + "            <div class=\"col-25\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type=\"text\" id=\"lname\" name=\"Apellido\" value='" + e.getLast_Name()+ "' placeholder=\"Employee's Last Name\" required maxlength=\"45\">\n"
                + "            </div>\n"
                + "        </div>\n"
                + "        <div class=\"row\">\n"
                + "            <div class=\"col-25\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type=\"text\" id=\"lname\" name=\"password\" value='" + e.getPassword() + "' placeholder=\"Employee's Password\" required maxlength=\"45\">\n"
                + "            </div>\n"
                + "        </div>\n"
                + "        <div class=\"row\">\n"
                + "            <div class=\"col-25\">\n"
                ...
                + "            </div>\n"
                + "            <div class=\"col-75\">\n"
                + "                <input type='date'    name='Fecha_ingreso'    value='" + e.getFecha() + "'/ required>\n"
                + "            </div>\n"
                + "        </div>\n"        

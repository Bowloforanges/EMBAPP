...
<div class="container">
    <form action="CTL_ACTUALIZAR_BD" method="post">
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="fname" name="ID_E" placeholder="Employee's ID">
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <input type="text" id="lname" name="Nombre" placeholder="Employee's Name">
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <input type="text" id="lname" name="password" placeholder="Employee's Password">
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <select id="Position" name="Puesto">
